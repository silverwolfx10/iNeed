	...
	<div class="container">
		...
		<!--  COPIAR DAQUI-->
			...
			<div class="linha">
				...
				<div class="campo">
					<input type="radio" name="semestre" <c:if test="${nota.semestre == 1 || nota == null}"> checked="checked"</c:if> value="1"> 1�
					<input type="radio" name="semestre" <c:if test="${nota.semestre == 2}"> checked="checked"</c:if> value="2">2�
				</div>
			</div>
		<!-- ATE AQUI -->
			<div class="submit">
